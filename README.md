...
AI-powered smart contract auditing API built with FastAPI, CrewAI, and LLMs.  
Automatically detects vulnerabilities, suggests gas optimizations, and evaluates code quality.
